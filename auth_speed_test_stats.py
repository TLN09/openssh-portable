...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        "--results", help="File containing results from test", type=str, required=True
    )
    arg_parser.add_argument(
        "--test-type", help="The type of test conducted", type=str, required=True
    )
    arg_parser.add_argument(
        "--key-type",
        help="Key type used for the test",
        type=str,
        required=True,
    )
    arg_parser.add_argument(
        "-i",
        "--include-header",
        help="Whether or not to include the initial CSV header",
        action="store_true",
        required=False,
    )
